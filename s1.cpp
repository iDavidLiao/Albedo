...
namespace ComputerVisionProjects {
    ...
    public:
        ...
        //function to locate the center and radius of an object
        //in the image
        void LocateCenterAndRadius(string output_file)
        {
            ...
            //stores all the pixels in a map if it is part of the object
            multimap<int, int> xcoordycoord;
            ...
            //iterate through the map to find the smallest x and y coordinate
            for(auto it = xcoordycoord.begin(); it != xcoordycoord.end(); it++)
            {
            ...
            //iterate through the map to find the largest x and y coordinate
            for(auto it = xcoordycoord.begin(); it != xcoordycoord.end(); it++)
            {
            ...
            //write the center x center y and radius to the file
            ofstream file;
...
namespace ComputerVisionProjects {
    ...
    bool ReadImage(const string &filename, Image *an_image, string threshold) {
...
main(int argc, char **argv){
    ...
    an_image.LocateCenterAndRadius(output_file);
